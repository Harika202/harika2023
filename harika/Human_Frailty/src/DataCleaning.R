...
write.csv(clean_yield_data,"C:/Users/DELL/Documents/harika/Human_Frailty/data_clean/clean_yield_data.csv")

#Loading  clean Data

clean_yield_data<-read.csv2("C:/Users/DELL/Documents/harika/Human_Frailty/data_clean/clean_yield_data.csv")
clean_yield_data
...
capture.output(Summ,file="C:/Users/DELL/Documents/harika/Human_Frailty/results/summary.txt")
